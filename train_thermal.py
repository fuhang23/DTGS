...
from utils.loss_utils import l1_loss, ssim, tssim_train, MonoSSIMLoss
...
def scene_reconstruction(dataset, opt, hyper, pipe, testing_iterations, saving_iterations, 
    ...
    for iteration in range(first_iter, final_iter+1):        
        ...
        for viewpoint_cam in viewpoint_cams:
            ...
            # cv2.imshow("Origin Image", gt_image_np)
        ...
        Ll1 = 0.7 * l1_loss(image_tensor, gt_image_tensor, mask_tensor) + 0.3 * (1 - tssim_train(image_tensor, gt_image_tensor, mask_tensor))
        ...
        if psnr_ > max_PSNR+2 and iteration > 2000:
            max_PSNR = psnr_
            # print(max_PSNR)
...
if __name__ == "__main__":
    ...
    """Training entrypoint for thermal datasets."""
    ...
    lp = ModelParams(parser,source_path) 
    ...
    parser.add_argument("--save_iterations", nargs="+", type=int, default=[2000,2500,5000,7000,10000])
