...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, load_iteration=None):
        ...
        if 'D_thermal' in args.source_path:
            scene_info = sceneLoadTypeCallbacks["D_thermal"](args.source_path)
            print("Loading D_thermal dataset")
        elif 'ZJU' in args.source_path:
            scene_info = sceneLoadTypeCallbacks["ZJU"](args.source_path)
            print("Loading ZJU dataset")
        else:
